...
const BooksPage = () => {
  ...
  const clearFilters = () => {
    setFilters({ stream: '', class_level: '', subject: '', search: '' });
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs text-gray-500 mb-3">
                      <span className="bg-gray-100 px-2 py-1 rounded">{book.stream}</span>
                      <span className="bg-gray-100 px-2 py-1 rounded">Class {book.class_level}</span>
                      <span className="bg-gray-100 px-2 py-1 rounded">{book.subject}</span>
                    </div>
                    <p className="text-sm text-gray-700 mb-3">{book.topic}</p>
                    {book.summary && (
